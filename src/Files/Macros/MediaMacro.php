...
class MediaMacro extends \Nette\Latte\Macros\MacroSet
{
	...
	{
		return $writer->write('echo $basePath . \Venne\System\Content\Macros\MediaMacro::proccessFile(%node.word)');
	}
	...
	{
		return $writer->write('echo $basePath . \Venne\System\Content\Macros\MediaMacro::proccessImage(%node.word, %node.array)');
	}
	...
	/**
	 * @param BaseRepository $fileDao
	 */
	public static function setFileDao($fileDao)
	{
